...
@section('content')
    ...
    <div class="container mx-auto px-4 mt-6">
        <div class="bg-green-100 shadow-md p-6 rounded-lg text-center">
            <h1 class="text-2xl md:text-4xl font-bold text-green-800 mb-4">
                Selamat Datang di <span class="text-green-900">SampahBijak</span>
            </h1>
            <p class="text-gray-700 text-base md:text-lg">
                Mari sama-sama kita wujudkan lingkungan bersih dan sehat melalui pengelolaan sampah yang bijak dan
                berkelanjutan.
            </p>
            <button
                class="mt-6 inline-flex items-center bg-green-700 text-white px-6 py-2 rounded hover:bg-green-600 transition duration-200">
